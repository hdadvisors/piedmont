...
This section explores methods for estimating the amount of home equity that clients have earned since the purchase of their home. Two different methods for projecting equity will be used: the first uses property assessment from the City of Charlottesville, while the second uses property sales records from MLS.
...
**Step 1:** Select earliest recorded DPL clients who purchased a home in the City of Charlottesville. This gives us the longest ownership timeframe for accruing home equity.
...
**Step 2:** Determine which neighborhoods the homes are in. The averages for these neighborhoods will be used as benchmarks.
...
cv_nhoods <- st_read("data/shp/Planning_Neighborhood_Area.shp") |> 
    st_transform(4502)
...
**Step 3:** Calculate change in median assessed value from 2017 to 2022 for each neighborhood.
...
**Step 4:** Calculate percent change in assessed value for client homes and respective neighborhoods.
...
ggplot(prop_assess, aes(x = TaxYear, y = pct_chg, color = value)) +
  ...
  labs(title = "Value of DPL client homes versus surrounding neighborhoods",
       ...
       caption = "**Notes:** Homes sold to clients in 2017. Neighborhood average derived from median value<br>of all single-family residential properties.")

```

The plot on the left shows a client's home they purchased in the Fifeville neighborhood in 2017 increasing in total assessed value by almost 50 percent by 2022, compared to a neighborhood average increase of 38 percent.
